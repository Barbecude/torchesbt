...
public class Particles {
    public static final SimpleParticleType CANDLE_SMOKE = FabricParticleTypes.simple(false);
    public static final SimpleParticleType TORCH_SMOKE = FabricParticleTypes.simple(false);

    public static void register() {
        Registry.register(
                Registries.PARTICLE_TYPE,
                Identifier.of(MOD_ID, "candle_smoke"),
                CANDLE_SMOKE
        );

        Registry.register(
                Registries.PARTICLE_TYPE,
                Identifier.of(MOD_ID, "torch_smoke"),
                TORCH_SMOKE
        );
    }
